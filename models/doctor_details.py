...
class AssurancePlan(models.Model):
    ...
    cups_ids = fields.One2many('doctor.cups.code', 'plan_id', string='Procedures')
...
class DoctorAdministrativeData(models.Model):
    ...
    dead = fields.Boolean(string="Dead", default=False)
    dead_date = fields.Date(string="Dead Date")
    health_professional = fields.Boolean(string="Health profesional", default=False)
